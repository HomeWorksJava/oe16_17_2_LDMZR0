 ...
 */
package com.mitro.persistence.entities;
...
@NamedQueries(value = {
    ...
    @NamedQuery(name = OwnerQuery.GET_ALL, query = "SELECT o FROM GuitarOwner o JOIN FETCH o.guitars ORDER BY o.ownerUsername")
})
