 ...
 * @author hallgato
 */
@WebServlet("/html/admin/Guitars")
public class GuitarController extends HttpServlet{

    private static final Logger LOGGER = Logger.getLogger(GuitarController.class.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            RequestDispatcher view = request.getRequestDispatcher("/html/admin/listguitars.jsp");
